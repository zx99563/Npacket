...
public class SwaggerConfig {
    ...
    public ApiInfo createAI(){
        ApiInfo apiInfo=new ApiInfoBuilder().title("一网兜API网络相关接口文档").
                description("一网兜系统的对外服务的相关接口信息，可以查看对应的接口信息和对接口进行测试").
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(createAI()).select().
                apis(RequestHandlerSelectors.basePackage("com.feri.netpacket.api.controller")).build();
    }
}